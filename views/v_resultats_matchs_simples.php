    ...
    <div class="match-wrapper d-flex align-items-center flex-column">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <div class="match-result-item">
              <p><?= $joueurDAO->getJoueur($ms->getEquipe1())->getNom() ?></p>
            </div>

            <div class="match-result-item">
              <p><?= $ms->getHeureMatch() ?></p>
            </div>

            <div class="match-result-item">
              <p><?= $joueurDAO->getJoueur($ms->getEquipe2())->getNom() ?></p>
            </div>
          </td>
          <td>
